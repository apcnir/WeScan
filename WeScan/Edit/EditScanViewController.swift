...
final class EditScanViewController: UIViewController {
    ...
    lazy private var nextButton: UIBarButtonItem = {
        let title = NSLocalizedString("wescan.edit.button.next", tableName: nil, bundle: Bundle(for: EditScanViewController.self), value: "Siguiente", comment: "A generic next button")
    ...
    lazy private var cancelButton: UIBarButtonItem = {
        let title = NSLocalizedString("wescan.edit.button.cancel", tableName: nil, bundle: Bundle(for: EditScanViewController.self), value: "Cancelar", comment: "A generic cancel button")
    ...
    override func viewDidLoad() {
        ...
        setupViews()
        setupConstraints()
        title = NSLocalizedString("wescan.edit.title", tableName: nil, bundle: Bundle(for: EditScanViewController.self), value: "Editar Scan", comment: "The title of the EditScanViewController")
