...
final class ReviewViewController: UIViewController {
    ...
    lazy private var doneButton: UIBarButtonItem = {
        ...
        let button = UIBarButtonItem(title: "Listo", style: .done, target: self, action:  #selector(finishScan))
    ...
    override func viewDidLoad() {
        ...
        title = NSLocalizedString("wescan.review.title", tableName: nil, bundle: Bundle(for: ReviewViewController.self), value: "Revisar", comment: "The review title of the ReviewController")
